...
<p class="hidden">{{$page_title = "Wartungs Vertrag bearbeiten"}}</p>
...
<div class="container" role="main">
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<!-- New Bill Form -->
			<form action="/updateService/{{$contract->id}}" method="POST"
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input class="form-control datepicker" id="contract-von"
								type="text" name="von" value="{{$contract->von}}" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input class="form-control datepicker" id="contract-bis"
								type="text" name="bis" value="{{$contract->bis}}" readonly>
						</div>
					</div>
					<! ---------------- bezahlt bis ---------------- -->
					<div class="form-group">
