...
<p class="hidden">{{$page_title = "Hosting Angebote"}}</p>
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover dataTable">
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><a href="{{ url('/addHostingOffer') }}">
									<button type="button" class="btn btn-success">Hosting Angebot erstellen</button>
							</a></td>
						</tr>
						@endrole
