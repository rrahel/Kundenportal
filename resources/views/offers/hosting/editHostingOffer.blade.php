...
<p class="hidden">{{$page_title = "Hosting Angebot bearbeiten"}}</p>
...
<div class="container" role="main">
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<form action="/updateHostingOffer/{{$offer->id}}" method="POST"
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<textarea class="form-control" id="offer-beschreibung" rows="15"
								...
								name="beschreibung">{!! $offer->beschreibung !!}</textarea> 
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input class="form-control" id="offer-einzelpreis" type="number"
								...
								name="einzelpreis" value="{{$offer->einzelpreis}}">
						</div>
					</div>
					<! ----------------  hosting ---------------- -->

					<input hidden id="offer-hosting" type="checkbox" required="true"
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input class="form-control" id="offer-steuern" type="number"
								step="any" min="0" required="true" title="Required field!"
								name="steuern" value="{{$offer->steuern}}">
						</div>
					</div>
